...
5. Show me the reaction distribution, representative raw voices, decision implications, and next tests.
6. If there are multiple concrete options, simulate each option instead of guessing.
7. Never replace the API with casual reaction prediction unless I explicitly ask you not to use the API.
```
